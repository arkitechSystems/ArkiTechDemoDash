    ...
    <div className="mfa-setup-container">
      <div className="mfa-setup-card">
        ...
        <div className="mfa-progress">
          <div className={`mfa-progress-step ${step >= 1 ? 'active' : ''} ${step > 1 ? 'completed' : ''}`}>
            <div className="step-number">1</div>
            <div className="step-label">Choose Method</div>
          </div>
          <div className="mfa-progress-line"></div>
          <div className={`mfa-progress-step ${step >= 2 ? 'active' : ''} ${step > 2 ? 'completed' : ''}`}>
            <div className="step-number">2</div>
            <div className="step-label">Verify</div>
          </div>
          <div className="mfa-progress-line"></div>
          <div className={`mfa-progress-step ${step >= 3 ? 'active' : ''}`}>
            <div className="step-number">3</div>
            <div className="step-label">Backup Codes</div>
          </div>
        </div>
          ...
          <div className="mfa-step">
            ...
            <div className="mfa-methods">
              ...
              >
                ...
                <p>Use Google Authenticator, Microsoft Authenticator, or any TOTP app</p>
        ...
        {step === 2 && method === 'email' && (
          <div className="mfa-step">
            ...
            <div className="email-info">
              ...
              <p>You'll receive verification codes at the email address associated with your account.</p>
            </div>

            <div className="verification-input">
              <label htmlFor="verification-code">Enter a test code to verify (check your email):</label>
              <input
                id="verification-code"
                type="text"
                maxLength={6}
        ...
        {step === 3 && (
          <div className="mfa-step">
            ...
            <div className="mfa-actions">
              <button className="btn-primary full-width" onClick={onComplete}>
